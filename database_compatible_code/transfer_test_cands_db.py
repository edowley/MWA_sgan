...
labelled_mask = (20000 <= database_df.index) & (database_df.index <= 60000) & ~np.isnan(database_df['Avg rating'].to_numpy(dtype = float))
...
'''
# Retrieve the Candidate ids (only necessary if steps not performed in a smooth sequence)
candidate_ids = []
